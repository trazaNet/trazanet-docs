...
- **[Deep Linking & Sharing](./DEEP_LINKING_SHARING.md)**: Architecture for sharing Lotes via `trazanet://` links.
- **[UI Improvements](./UI_IMPROVEMENTS.md)**: Details on Login refactor and iOS Navbar fixes.
- **[SNIG Export](./SNIG_EXPORT.md)**: Format specification for TXT export.
